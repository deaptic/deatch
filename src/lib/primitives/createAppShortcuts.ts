...
export function createAppShortcuts(
  ...
  onMount(() => {
    const unbind = [
      shortcutManager.register("channel::cycleNext", () => watch.cycleChannel(1)),
      shortcutManager.register("channel::cyclePrev", () => watch.cycleChannel(-1)),
      ...
      shortcutManager.register("watch::toggleMuteAll", watch.toggleMuteAllWatched),
